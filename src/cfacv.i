...
extern SMDataSpace* New_stringMethod_Dataspace ( int ni, int nz, int reparam_maxiter, double reparam_tol, int outputlevel, double nu );
...
extern int DataSpace_StringMethod_RawUpdate ( DataSpace * ds, double stepsize, int timestep );
